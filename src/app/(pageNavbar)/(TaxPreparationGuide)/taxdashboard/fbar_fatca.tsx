...
import { isFbarFatcaSubmitted, updateFilingYearWithDetails } from "@/app/api/SupabaseAPI/customer/fbarAPI";
...
export default function FBARFATCA({ setActiveTab }: FbarProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await updateFilingYearWithDetails(Number(filingYearId), hasForeignAccount, exceededLimit);
