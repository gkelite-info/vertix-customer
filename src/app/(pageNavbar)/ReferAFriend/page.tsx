              ...
              `}
                        ...
                        <div className="bg-gray-00 w-[95%] flex flex-col items-center p-3 mt-5">
                            ...
                            <form className="w-full max-w-lg mt-3 bg-white shadow-md rounded-lg p-5">
                                <div className="mb-4 flex items-center gap-3">
                                    <label className="block text-sm font-medium text-[#1D2B48] w-[40%] text-end">FIRSTNAME :</label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4 flex items-center gap-3">
                                    <label className="block text-sm font-medium text-[#1D2B48] w-[40%] text-end">LASTNAME :</label>
                                    <input
                                        type="text"
                                        className="w-full border border-gray-300 rounded text-[#1D2B48] px-3 py-2 mt-1 focus:outline-none focus:border-blue-500"
                                ...
                                <div className="mb-4 flex items-center gap-3">
                                    <label className="block text-sm font-medium text-[#1D2B48] w-[40%] text-end">EMAIL :</label>
                                    <input
                                        type="email"
                                        className="w-full border border-gray-300 rounded text-[#1D2B48] px-3 py-2 mt-1 focus:outline-none focus:border-blue-500"
                                ...
                                <div className="mb-4 flex items-center gap-3">
                                    <label className="block text-sm font-medium text-[#1D2B48] w-[40%] text-end">PHONE :</label>
                                    <select
                                    ...
                                    <label className="block text-sm font-medium text-[#1D2B48] w-[40%] text-end">ALTERNATE NUMBER :</label>
                                    <select
                                        className="border border-gray-300 rounded text-[#1D2B48] px-2 py-2 mt-1 focus:outline-none focus:border-blue-500 w-[20%]"
                                        defaultValue="+1"
                                    >
                    ...
                    {activeSection === "registeredReferrals" && (
                        <div className="bg-gray-00 w-[90%] flex flex-col items-center p-3 mt-5">
                            <h2 className="text-[#1D2B48] font-semibold text-xl">Your Referrals</h2>
                            <table className="w-[100%] border-collapse border border-gray-300 bg-white shadow-md mt-3">
                                <thead>
                                    <tr className="bg-[#4B5873] text-center">
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold w-10">S.No</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">Client Id</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">First Name</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">Email-Id</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">Status</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">Amount Eligible</th>
                                        <th className="border border-gray-300 px-4 py-2 text-sm font-semibold">Pay Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr className="bg-[#E9E9E9] text-black text-center">
                                        <td className="border border-gray-300 px-4 py-2 text-sm">1</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">123456789</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">User</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">User@gmail.com</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">Process Completed</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">10</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">Green in Summary</td>
                                    </tr>
                                    <tr className="bg-[#E9E9E9] text-black text-center">
                                        <td className="border border-gray-300 px-4 py-2 text-sm">2</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">123456789</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">User</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">User@outlook.com</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">Already Filed</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">10</td>
                                        <td className="border border-gray-300 px-4 py-2 text-sm">Green in Summary</td>
                                    </tr>
                                </tbody>
