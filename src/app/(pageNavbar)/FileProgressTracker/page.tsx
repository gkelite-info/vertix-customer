    ...
    <>
      <div className="bg-white lg:h-[100vh]">
        ...
        <div className="bg-red-00 flex flex-col justify-start items-center lg:h-[80%] lg:pt-5">
          <div className="bg-white flex justify-center items-start text-center lg:h-[27%] lg:w-[75%] rounded-lg shadow-lg">
          ...
          <div className="bg-white w-[75%] mt-15 gap-1 flex flex-col">
