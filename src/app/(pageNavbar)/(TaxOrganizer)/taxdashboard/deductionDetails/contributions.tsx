    ...
    return (
        <>
            <div className="bg-red-00 w-[100%] mt-4 gap-2 flex flex-col">
                ...
                <div className="flex items-center justify-between py-1">
                    <h5 className="text-[#616161] font-medium text-sm">Did you make contributions to Health savings Account or Medical Savings Account ? (other than W2)</h5>
                    <ToggleSwitch labelLeft="No" labelRight="Yes" />
                </div>
                <div className="flex items-center justify-between py-1">
                ...
                <div className="bg-blue-00 w-[100%] mt-3 flex flex-col py-3 justify-between gap-2">
