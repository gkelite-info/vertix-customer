                ...
                <div className="bg-red-00 flex justify-center items-start lg:h-[80%] lg:w-[100%] lg:pt-5">
                    <div className="bg-green-00 flex flex-col justify-between items-center text-center lg:h-[39%] lg:w-[40%] lg:gap-2">
                        <div className="flex flex-col lg:gap-1">
                            ...
                            <p className="text-[#2B2B2B] text-xs font-medium">To proceed further, add service year for which you want to file tax return.</p>
                        </div>
                        ...
                        <button className="bg-[#1D2B48] font-medium lg:w-[40%] lg:h-[25%] cursor-pointer hover:bg-[#2c3e65] rounded-lg text-sm">ADD NEW SERVICE</button>
                    </div>
                </div>
            </div>
        </>
