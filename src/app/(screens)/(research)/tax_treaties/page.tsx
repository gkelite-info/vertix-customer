      ...
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto px-4 lg:px-4 lg:gap-2 lg:pb-10">
        ...
        <div className="w-full mt-6 lg:mt-10 flex flex-col lg:flex-row lg:w-[90%]">
          <div className="w-full lg:w-[60%] lg:pt-5 lg:pr-7">
            <p className="text-[#1C2A46] text-sm mt-3">
              India-US Tax Treaty: Avoid Double Taxation & Maximize Benefits The
              India-US Tax Treaty helps Indian residents working, studying, or
              researching in the U.S. avoid double taxation on the same income.
              This ensures you pay tax only where required and can claim
              exemptions or deductions under the treaty.
            </p>
            ...
            <p className="text-[#1C2A46] text-sm mt-3">
              Scholarships & Stipends from India: Payments received from India
              (or any country outside the U.S.) for education, maintenance, or
              training are generally exempt from U.S. tax under Article 21.
              <br className="hidden sm:inline" />
              U.S. Income: Payments received from U.S. sources, like
              scholarships or assistantships from a university, are taxable.
              <br className="hidden sm:inline" />
              Nonresident Status: Most international students are considered
              nonresidents for U.S. tax purposes, so foreign-source income is
              usually tax-free.
              <br className="hidden sm:inline" />
              Standard Deduction: Unlike other nonresidents, Indian students may
              claim the standard deduction instead of itemizing, which often
              results in lower taxes.
              <br className="hidden sm:inline" />
            </p>
            <p className="text-[#1C2A46] text-sm mt-3">
              Dependent Exemption: F-1 and J-1 students can{" "}
              <br className="hidden sm:inline" />
            ...
            <p className="text-[#1C2A46] text-sm mt-3">
              ...
              <br className="hidden sm:inline" />
              Are not claimed as dependents by another taxpayer
              <br className="hidden sm:inline" />
              Do not have any U.S. gross income
              <br className="hidden sm:inline" />
              Are not on F-2 or J-2 visas (except spouses meeting the above
              criteria)
              <br className="hidden sm:inline" />
              Are U.S. citizen children
              <br className="hidden sm:inline" />
            </p>
          </div>
        ...
        <div className="w-full lg:w-[90%] flex flex-col">
          ...
          <p className="text-[#1C2A46] text-sm mt-3">
            ...
            country.
            <br className="hidden sm:inline" />
            Residence is defined by the domestic laws of each country —
            generally meaning the person is liable to pay tax in that country.
            <br className="hidden sm:inline" />
            Important: If a foreign employer’s U.S. branch reimburses or charges
          ...
          <p className="text-[#1C2A46] text-sm mt-3">
            ...
            <br className="hidden sm:inline" />
            Research income qualifies only if undertaken in the public interest,
          ...
          <p className="text-[#1C2A46] text-sm mt-3 mb-10">
            ...
            <br className="hidden sm:inline" />
            Prevents double taxation on your Indian and U.S. income
            <br className="hidden sm:inline" />
            Ensures you claim all exemptions and deductions available under the
            treaty
            <br className="hidden sm:inline" />
            Vertix Tax Solutions guides Indian students, professionals, and
            researchers in the U.S. to maximize treaty benefits and stay fully
