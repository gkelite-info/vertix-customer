        ...
        <>
            <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2 lg:pb-10">
                <div className="lg:h-[20%] lg:w-[45%] flex flex-col items-center lg:mt-10">
                    <h1 className="border border-b-4 border-l-0 border-t-0 border-r-0 text-[#1D2B48] text-xl font-bold lg:w-[43%]">STANDARD GUARANTEE</h1>
                </div>
                <div className="bg-yellow-00 lg:w-[90%] lg:mt-10 flex">
                    <div className="lg:w-[60%] lg:pt-5 lg:pr-7 flex flex-wrap lg:gap-5">
                        <a href="#notices" className="lg:h-[45%] lg:w-[40%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                        ...
                        <a href="#accuracy" className="lg:h-[45%] lg:w-[40%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                            <div className="bg-red-00 flex flex-col items-center justify-around lg:h-[100%] lg:w-[100%] lg:p-5 lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                                <div className="bg-blue-200 lg:p-2 lg:h-[49%] lg:w-[35%] lg:rounded-full flex justify-center items-center">
                        ...
                        <a href="#taxpayment" className="lg:h-[45%] lg:w-[40%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                            <div className="bg-red-00 flex flex-col items-center justify-around lg:h-[100%] lg:w-[100%] lg:p-5 lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                                <div className="bg-blue-200 lg:p-2 lg:h-[49%] lg:w-[35%] lg:rounded-full flex justify-center items-center">
                ...
                <div className="bg-green-00 lg:w-[90%]">
                    ...
                    <h1 id="notices" className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-24">If You Receive a Notice</h1>
                    ...
                    <h1 id="accuracy" className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-24">If We Didn’t Make a Mistake:</h1>
                    ...
                    <h1 id="taxpayment" className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-24">Income Tax Due:</h1>
