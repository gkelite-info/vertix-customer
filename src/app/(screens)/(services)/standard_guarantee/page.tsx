    ...
    <>
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2 lg:pb-10">
        <div className="lg:h-[20%] lg:w-[45%] flex flex-col items-center lg:mt-10">
          <h1 className="border border-b-4 border-l-0 border-t-0 border-r-0 text-[#1D2B48] text-xl font-bold lg:w-[43%]">
            STANDARD GUARANTEE
          </h1>
        </div>
        ...
        <div className="bg-green-00 lg:w-[90%]">
          ...
          <p className="text-[#1C2A46] text-sm lg:mt-3">
            ...
            clients after the filing of their tax returns with complimentary tax
            question assistance from an Enrolled Agent, admitted to practice
            before the IRS in all 50 states. We reimburse for interest and
            penalties assessed due to a legitimate preparer error and provide
          ...
          <p className="text-[#1C2A46] text-sm lg:mt-3">
            ...
            needs to be done to respond to it. We will assist you in responding
            to the notice. We may ask you to sign documents so we can get
