...
function Page() {
  return (
    <>
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto px-3 gap-3 pb-6 lg:px-4 lg:gap-2 lg:pb-10">
        ...
        <div className="w-full mt-6 flex flex-col lg:flex-row lg:w-[90%] lg:mt-10">
          ...
          <div className="w-full lg:w-[60%] mt-0 lg:pt-0 lg:pr-7">
        ...
        <div className="w-full lg:w-[90%]">
          ...
          <p className="text-blue-500 text-sm lg:mt-4 mt-0 cursor-pointer break-all">
