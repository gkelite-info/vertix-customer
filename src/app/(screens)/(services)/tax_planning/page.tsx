        ...
        <div className="bg-yellow-00 lg:w-[90%] lg:mt-10 flex">
          <div className="lg:w-[60%] lg:pt-5 lg:pr-7">
            ...
            <p className="text-[#1C2A46] lg:text-sm lg:mt-2">
              Tax planning is a valuable tool you can use to save tax dollars
              and create wealth.
            </p>
            ...
            <p className="text-[#1C2A46] text-sm lg:mt-3">
              We provide simple tax planning to our tax clients as a
            ...
            <p className="text-[#1C2A46] text-sm lg:mt-3">
              ...
              comprehensive tax planning program. We are happy to help existing
              clients and new clients wanting to plan for their tax future.
            </p>
          </div>
