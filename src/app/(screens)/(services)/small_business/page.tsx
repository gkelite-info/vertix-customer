        ...
        <>
            <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2">
                ...
                <div className="bg-green-00 lg:w-[90%]">
                    <h1 className="text-[#1C2A46] font-medium lg:mt-8">Multiple Member LLC’s, Partnerships, S-Corps</h1>
                    <p className="text-[#1C2A46] text-sm lg:mt-3">The default tax status of this type of LLC is that of a partnership. The LLC members can file proper paperwork with the IRS to elect a different tax status, usually that of an S-corporation.</p>
                    <p className="text-[#1C2A46] text-sm lg:mt-3">The business is required to file it’s tax return first and then issue a tax form, K-1, reporting each partner’s or shareholder’s share of income, deductions and credits that has to be reported on the partner’s personal tax return.</p>
                </div>
