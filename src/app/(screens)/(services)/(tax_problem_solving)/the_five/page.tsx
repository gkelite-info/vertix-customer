      ...
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2 lg:pb-10">
        ...
        <div className="bg-yellow-00 lg:w-[90%] lg:mt-10 flex">
          <div className="lg:w-[60%] lg:pt-5 lg:pr-7">
            ...
            <p className="text-[#1C2A46] lg:text-sm lg:mt-2">
              ...
              against all of your property that you now own or may own in the
              future and your rights to property. A Notice of Lien is a public
              notice to creditors that your property is now encumbered with a
              tax debt that takes priority over their debt. A tax lien can
              prevent you from selling or buying property until the tax debt is
            ...
            <p className="text-[#1C2A46] lg:text-sm lg:mt-2">
              ...
              authority comes from federal or state laws. They are required to
              follow specific procedures to make certain that your rights of due
        ...
        <div className="bg-green-00 lg:w-[90%]">
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            IRS almost always files a tax lien if you owe more than $10,000, but
            can file one for less if it is in the government’s best interest,
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            State. Lists of filings are sometimes reported in newspapers. Other
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            Program hearing. Each process has specific timing and legal
            requirements. The Collection Due Process allows you to go to tax
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            already filed. They might help you work out an arrangement that will
          ...
          <ol className="list-disc lg:mt-2 lg:ml-8">
            ...
            <li className="text-[#1C2A46] text-sm">
              Offer in Compromise to settle with the IRS for an amount less than
              what you owe.
            </li>
            <li className="text-[#1C2A46] text-sm">
              Request that the IRS stop collection activities because of your
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            A lien withdrawal doesn’t make the tax debt goes away, it just lets
            other creditors know that the lien has been withdrawn. A withdrawal
            is usually at the discretion of the taxing authority after a review
            of your application for the lien withdrawal. A federal lien
            withdrawal is completed when the IRS files a Notice of Federal Lien
            Withdrawal with the same office where the lien was filed. It doesn’t
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            similar procedures depending upon the laws of each state. What can I
            do if the IRS won’t agree to withdraw, discharge or subordinate the
            tax lien? You can file a Collection Appeal Request to have the
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            debts sitting across from me at my office. Sometimes the IRS or
            state tax department has placed a lien on their property or levied
            on a bank account or garnished wages. They’ve come looking for help.
            They have made the first step…the most important one…stop ignoring
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            about your particular situation. No fee will be due unless you
            engage us to represent you.
          </p>
        </div>
      </div>
    </>
