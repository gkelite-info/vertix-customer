      ...
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto px-3 gap-4 pb-6 lg:px-4 lg:gap-2 lg:pb-10">
        ...
        <div className="w-full lg:w-[90%]">
          ...
          <p className="text-[#1C2A46] lg:text-sm lg:mt-2 mt-1">
            ...
            required documents or information. We provide this service for our
            tax clients as part of our standard guarantee. Engagement Agreements
            are beneficial so that everyone understands the scope of the
          ...
          <p className="text-[#1C2A46] text-md lg:mt-3">
            ...
            you to sign an Engagement Agreement, pay a retainer for services,
            and sign an authorization to allow us to receive information from
            the IRS about your tax account. We may ask you to sign a Power of
            Attorney, as well. This is a fee paid service for both clients and
            non-clients.
          </p>
          ...
          <p className="lg:mt-2 mt-1 text-[#1C2A46] lg:text-sm">
            ...
            assessed tax due based upon information received from third party
          ...
          <p className="lg:mt-2 mt-1 text-[#1C2A46] lg:text-sm">
            ...
            computer generated notice is sent to you if there is a mismatch of
          ...
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
            ...
            computer may have generated the notice–not a human being. Also, the
            IRS may make adjustments to your tax return that could affect your
            claimed tax credits, deductions or dependents. These adjustments, if
            ignored or misunderstood, could cause problems for you in past year
            returns, state tax returns, or future year tax filings. Don’t take
            any chances, don’t sign any documents or send any money unless you
          ...
          <p className="lg:mt-3 text-[#1C2A46] lg:text-sm mt-1">
            ...
            for unpaid taxes and create problems with selling property or
            obtaining credit. They add interest and late payment penalty each
          ...
          <ol className="list-disc lg:mt-2 ml-4 lg:ml-8">
            ...
            <li className="text-[#1C2A46] text-sm">
              Collection Levies and Liens, read our articles about levies or
              liens for more information;
            </li>
            <li className="text-[#1C2A46] text-sm">
              Currently Not Collectible, stop collections until your financial
              situation improves;
            </li>
            <li className="text-[#1C2A46] text-sm">
              Offers In Compromise, settle for less than what you owe;
            </li>
            <li className="text-[#1C2A46] text-sm">
              Statute of Limitations, the legal date when you no longer have to
              pay a tax debt;
            </li>
            <li className="text-[#1C2A46] text-sm">
              Penalty Abatement, when the IRS or state removes penalties from
              your tax debt;
            </li>
            <li className="text-[#1C2A46] text-sm">
              Custom Solutions, there are other ways to resolve a tax debt, such
              as Audit Reconsideration or correcting previously filed returns
              and combinations of solutions.
            </li>
          </ol>

          <p className="lg:mt-3 text-[#1C2A46] lg:text-sm">
            We help taxpayers after a consultation where you get to know us, we
            get to know you and learn some facts about your situation. We follow
            a two step process in tax debt resolution.
          </p>
          ...
          <p className="lg:mt-3 text-[#1C2A46] lg:text-sm">
            ...
            financial and personal situation. We will gather information from
          ...
          <p className="lg:mt-3 text-[#1C2A46] lg:text-sm">
            ...
            filed tax returns, if part of the plan, is included with the fee for
            this step. We will quote a flat fee for each step and ask that you
          ...
          <ol className="list-disc lg:mt-2 ml-4 mt-1 lg:ml-8">
            ...
            <li className="text-[#1C2A46] text-sm">
              In-person where they ask you to bring your documents to an IRS
              office to meet with a Tax Examiner;
            </li>
            <li className="text-[#1C2A46] text-sm">
              The IRS agent visits you;
            </li>
            <li className="text-[#1C2A46] text-sm">
              A computer can’t match third party reporting with what you have on
              your tax return (CP2000). We provide full-service representation
          ...
          <p className="lg:mt-3 text-[#1C2A46] lg:text-sm">
            ...
            service and the pathways required to resolve the tax problem. Costs
            for copying, mailing, research, travel or transportation, or other
            out-of-pocket costs are billed separately from the retainer. We may
