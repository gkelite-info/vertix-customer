...
import { Airplane, Briefcase, Buildings, Clock, CreditCard, Envelope, Globe, Handshake, IdentificationCard, MagnifyingGlass, Note, Scales, Star, User, Users, UsersThree, WarningCircle } from "phosphor-react";
        ...
        <>
            <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2 lg:pb-10">
                    ...
                    <div className="lg:w-[60%] lg:pt-5 lg:pr-7 flex flex-wrap lg:gap-5">
                        ...
                        <a href="#permanentresidants" className="lg:h-[35%] lg:w-[30%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                            <div className="bg-red-00 flex flex-col items-center justify-around lg:h-[100%] lg:w-[100%] lg:p-5 lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                                ...
                                <div className="bg-yellow-00 lg:h-[30%] lg:w-full flex justify-center items-center">
                                    <h3 className="text-[#1D2B48] font-semibold text-center">Payment</h3>
                                </div>
                            </div>
                        </a>
                        <a href="#litigation" className="lg:h-[35%] lg:w-[30%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                            <div className="bg-red-00 flex flex-col items-center justify-around lg:h-[100%] lg:w-[100%] lg:p-5 lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                                <div className="bg-blue-200 lg:p-2 lg:h-[49%] lg:w-[35%] lg:rounded-full flex justify-center items-center">
                                    <Scales size={26} weight="fill" className="text-[#1D2B48]" />
                                </div>
                                <div className="bg-yellow-00 lg:h-[30%] lg:w-full flex justify-center items-center">
                                    <h3 className="text-[#1D2B48] font-semibold text-center">Litigation</h3>
                                </div>
                            </div>
                        </a>
                        <a href="#support" className="lg:h-[35%] lg:w-[30%] lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                            <div className="bg-red-00 flex flex-col items-center justify-around lg:h-[100%] lg:w-[100%] lg:p-5 lg:rounded-2xl lg:shadow-lg hover:shadow-xl cursor-pointer">
                                <div className="bg-blue-200 lg:p-2 lg:h-[49%] lg:w-[35%] lg:rounded-full flex justify-center items-center">
                ...
                <div className="bg-green-00 lg:w-[90%]">
                    ...
                    <h1 id="visaworkers" className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-24">Notices from IRS or States</h1>
                    ...
                    <h1 id="litigation" className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-24">Tax Court</h1>
                    ...
                    <h1 id="support" className="text-[#1C2A46] font-medium lg:mt-8">Resources</h1>
