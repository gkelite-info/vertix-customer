    ...
    <>
      <div className="flex flex-col items-center bg-[#FFFEFE] overflow-y-auto lg:px-4 lg:gap-2 lg:pb-10">
        ...
        <div className="bg-green-00 lg:w-[90%]">
          <h1
            id="individuals"
            className="text-[#1C2A46] font-medium lg:scroll-mt-30"
          >
            INDIVIDUALS:
          </h1>
          ...
          <h1 id="visaworkers" className="text-[#1C2A46] font-medium lg:mt-8">
            U.S. VISA WORKERS:
          </h1>
          <p className="lg:mt-2 text-[#1C2A46] lg:text-sm">
          ...
          <h1
            id="taxpayers"
            className="text-[#1C2A46] font-medium lg:mt-8 lg:scroll-mt-20"
          >
          ...
          <h1
            id="irregularworkers"
            className="text-[#1C2A46] font-medium lg:mt-8"
          >
